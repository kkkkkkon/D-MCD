...
if args.cuda:
    ...
    source_G = torch.nn.DataParallel(source_G.cuda())
    source_F1 = torch.nn.DataParallel(source_F1.cuda())
    source_F2 = torch.nn.DataParallel(source_F2.cuda())
