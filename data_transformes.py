...
class data_transformes(object):
    def __init__(self, hflip=True, xlat_range=2.0, affine_std=0.0, rot_std=0.0,
                 intens_flip=True,
                 ...
                 scale_x_range=None, scale_y_range=None, scale_u_range=None, gaussian_noise_std=0.05,
                 blur_range=None):
        self.hflip = hflip
